...
<!-- #EndLibraryItem --><table width="1002" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="rightimg"><!-- #BeginLibraryItem "/Library/left.lbi" --><div id="left">
        ...
        <h1>任务信息:</h1>
        <form action="managementTaskManager.do" method="post" name="form1" target="_self" id="form1">
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <tr>
            	<td colspan="8" align="center">
            		<a href="queryAllTaskForManager.do?pageNo=${pd.firstPage}&pageSize=${pd.pageSize}">首页</a>
      				<a href="queryAllTaskForManager.do?pageNo=${pd.previousPage}&pageSize=${pd.pageSize}">上一页</a>
					<a href="queryAllTaskForManager.do?pageNo=${pd.nextPage}&pageSize=${pd.pageSize}">下一页</a>
					<a href="queryAllTaskForManager.do?pageNo=${pd.lastPage}&pageSize=${pd.pageSize}">末页</a>

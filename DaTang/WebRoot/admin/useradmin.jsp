...
<div id="left2">
      ...
      <p ><a href="input_login.do" target="_self">退出系统</a></p>
	    ...
	    <form id="form1" name="form1" method="post" action="input_addperson.do">
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <tr>
            	<td colspan="7" align="center">
            		<a href="selectEmpLoyeeByPage.do?pageNo=${pd.firstPage}&pageSize=${pd.pageSize}">首页</a>
      				<a href="selectEmpLoyeeByPage.do?pageNo=${pd.previousPage}&pageSize=${pd.pageSize}">上一页</a>
					<a href="selectEmpLoyeeByPage.do?pageNo=${pd.nextPage}&pageSize=${pd.pageSize}">下一页</a>
					<a href="selectEmpLoyeeByPage.do?pageNo=${pd.lastPage}&pageSize=${pd.pageSize}">末页</a>
